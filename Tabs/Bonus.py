...
def create_bonus_tab(content_frame, tabs):
    ...
    bonus_tree = ttk.Treeview(bonus_frame, columns=("BonusID", "EmpID", "Bonus_Amount", "Sales", "Gross",
                                                    "Bonus_Percentage", "Current_Bonus_Percentage"), show="headings")
    bonus_tree.heading("BonusID", text="BonusID")
    bonus_tree.heading("EmpID", text="EmpID")
    bonus_tree.heading("Bonus_Amount", text="Bonus Amount")
    bonus_tree.heading("Sales", text="Sales")
    bonus_tree.heading("Gross", text="Gross")
    bonus_tree.heading("Bonus_Percentage", text="Bonus Percentage")
    bonus_tree.heading("Current_Bonus_Percentage", text="Current Bonus Percentage")
...
def add_bonus(emp_id, bonus_amount, sales, gross, bonus_percentage, current_bonus_percentage):
    ...
    if not emp_id:
        ...
        return
    try:
        query = """INSERT INTO Bonus (EmpID, Bonus_Amount, Sales, Gross, Bonus_Percentage, Current_Bonus_Percentage)
                   VALUES (%s, %s, %s, %s, %s, %s)"""
